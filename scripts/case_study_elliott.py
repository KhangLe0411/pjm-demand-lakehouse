...
print("=" * 86); print("1. WHAT HAPPENED — daily actuals around the event"); print("=" * 86)
...
print("\n" + "=" * 86); print("2. HOW EACH MODEL DID — event days only"); print("=" * 86)
...
print("\n" + "=" * 86); print("3. DIRECTION — did anyone see the ramp coming?"); print("=" * 86)
...
print("\n" + "=" * 86); print("4. PEAK behaviour on event days"); print("=" * 86)
...
print("\n" + "=" * 86); print("5. WORST SINGLE HOURS of the event"); print("=" * 86)
